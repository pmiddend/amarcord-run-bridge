...
class JsonIndexingFom(BaseModel):
    ...
    JsonIndexingFom
    """ # noqa: E501
    hit_rate: Union[StrictFloat, StrictInt]
    indexing_rate: Union[StrictFloat, StrictInt]
    ...
    __properties: ClassVar[List[str]] = ["hit_rate", "indexing_rate", "indexed_frames", "detector_shift_x_mm", "detector_shift_y_mm"]
