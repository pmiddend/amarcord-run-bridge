...
class JsonRunsBulkImportInfo(BaseModel):
    ...
    experiment_types: List[StrictStr]
    chemicals: List[JsonChemical]
    __properties: ClassVar[List[str]] = ["run_attributi", "experiment_types", "chemicals"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in run_attributi (list)
        _items = []
        if self.run_attributi:
            for _item_run_attributi in self.run_attributi:
                if _item_run_attributi:
                    _items.append(_item_run_attributi.to_dict())
            _dict['run_attributi'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "run_attributi": [JsonAttributo.from_dict(_item) for _item in obj["run_attributi"]] if obj.get("run_attributi") is not None else None,
            "experiment_types": obj.get("experiment_types"),
