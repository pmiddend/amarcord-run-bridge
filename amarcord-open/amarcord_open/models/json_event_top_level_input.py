...
class JsonEventTopLevelInput(BaseModel):
    ...
    with_live_stream: StrictBool
    __properties: ClassVar[List[str]] = ["beamtime_id", "event", "with_live_stream"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "event": JsonEventInput.from_dict(obj["event"]) if obj.get("event") is not None else None,
            "with_live_stream": obj.get("with_live_stream")
        })
        return _obj
