...
class JsonCreateAttributoInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["beamtime_id", "name", "description", "group", "associated_table", "attributo_type_integer", "attributo_type_number", "attributo_type_string", "attributo_type_array", "attributo_type_boolean"]
