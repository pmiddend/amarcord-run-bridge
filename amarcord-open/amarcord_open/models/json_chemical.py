...
class JsonChemical(BaseModel):
    ...
    name: StrictStr
    responsible_person: StrictStr
    chemical_type: ChemicalType
    attributi: List[JsonAttributoValue]
    files: List[JsonFileOutput]
    __properties: ClassVar[List[str]] = ["id", "beamtime_id", "name", "responsible_person", "chemical_type", "attributi", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "responsible_person": obj.get("responsible_person"),
            "chemical_type": obj.get("chemical_type"),
