...
class JsonCopyExperimentTypesOutput(BaseModel):
    ...
    """ # noqa: E501
    to_beamtime_experiment_type_ids: List[StrictInt]
    __properties: ClassVar[List[str]] = ["to_beamtime_experiment_type_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "to_beamtime_experiment_type_ids": obj.get("to_beamtime_experiment_type_ids")
        })
        return _obj
