...
class JsonUpdateRunsBulkInput(BaseModel):
    ...
    external_run_ids: List[StrictInt]
    attributi: List[JsonAttributoValue]
    new_experiment_type_id: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["beamtime_id", "external_run_ids", "attributi", "new_experiment_type_id"]
