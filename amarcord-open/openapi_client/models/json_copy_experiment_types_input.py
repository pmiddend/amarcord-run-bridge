...
class JsonCopyExperimentTypesInput(BaseModel):
    ...
    """ # noqa: E501
    from_beamtime: StrictInt
    to_beamtime: StrictInt
    __properties: ClassVar[List[str]] = ["from_beamtime", "to_beamtime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from_beamtime": obj.get("from_beamtime"),
            "to_beamtime": obj.get("to_beamtime")
        })
        return _obj
