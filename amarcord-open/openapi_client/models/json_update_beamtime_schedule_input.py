...
class JsonUpdateBeamtimeScheduleInput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["beamtime_id", "schedule"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schedule": [JsonBeamtimeScheduleRow.from_dict(_item) for _item in obj["schedule"]] if obj.get("schedule") is not None else None
        })
        return _obj
