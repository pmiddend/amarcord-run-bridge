...
class JsonRunsBulkImportOutput(BaseModel):
    ...
    number_of_runs: StrictInt
    data_sets: List[JsonDataSet]
    __properties: ClassVar[List[str]] = ["simulated", "create_data_sets", "errors", "warnings", "number_of_runs", "data_sets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "create_data_sets": obj.get("create_data_sets"),
