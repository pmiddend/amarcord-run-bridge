...
class AttributoType(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, JSONSchemaInteger):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `JSONSchemaInteger`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, JSONSchemaNumber):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `JSONSchemaNumber`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, JSONSchemaString):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `JSONSchemaString`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, JSONSchemaArray):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `JSONSchemaArray`"
            )
        else:
            match += 1
        ...
        if not isinstance(v, JSONSchemaBoolean):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `JSONSchemaBoolean`"
            )
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when setting `actual_instance` in AttributoType with oneOf schemas: JSONSchemaArray, JSONSchemaBoolean, JSONSchemaInteger, JSONSchemaNumber, JSONSchemaString. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when setting `actual_instance` in AttributoType with oneOf schemas: JSONSchemaArray, JSONSchemaBoolean, JSONSchemaInteger, JSONSchemaNumber, JSONSchemaString. Details: "
                + ", ".join(error_messages)
            )
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError(
                "Multiple matches found when deserializing the JSON string into AttributoType with oneOf schemas: JSONSchemaArray, JSONSchemaBoolean, JSONSchemaInteger, JSONSchemaNumber, JSONSchemaString. Details: "
                + ", ".join(error_messages)
            )
        elif match == 0:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into AttributoType with oneOf schemas: JSONSchemaArray, JSONSchemaBoolean, JSONSchemaInteger, JSONSchemaNumber, JSONSchemaString. Details: "
                + ", ".join(error_messages)
            )
        else:
            return instance
