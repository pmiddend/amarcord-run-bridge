...
class TestJsonMergeResultStateDone(unittest.TestCase):
    """JsonMergeResultStateDone unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonMergeResultStateDone:
        """Test JsonMergeResultStateDone
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonMergeResultStateDone`
        """
        model = JsonMergeResultStateDone()
        if include_optional:
            return JsonMergeResultStateDone(
                started = 56,
                stopped = 56,
    ...
    def testJsonMergeResultStateDone(self):
        """Test JsonMergeResultStateDone"""
