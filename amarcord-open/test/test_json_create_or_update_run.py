...
class TestJsonCreateOrUpdateRun(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonCreateOrUpdateRun:
        """Test JsonCreateOrUpdateRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonCreateOrUpdateRun`
        """
        model = JsonCreateOrUpdateRun()
        if include_optional:
    ...
    def testJsonCreateOrUpdateRun(self):
        """Test JsonCreateOrUpdateRun"""
