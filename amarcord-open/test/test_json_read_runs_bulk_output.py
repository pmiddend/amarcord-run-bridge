...
class TestJsonReadRunsBulkOutput(unittest.TestCase):
    """JsonReadRunsBulkOutput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonReadRunsBulkOutput:
        """Test JsonReadRunsBulkOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonReadRunsBulkOutput`
        """
        model = JsonReadRunsBulkOutput()
        if include_optional:
            return JsonReadRunsBulkOutput(
                ...
                attributi_values = [
                    amarcord_open.models.json_attributo_bulk_value.JsonAttributoBulkValue(
                        attributo_id = 56, 
                        values = [
                            amarcord_open.models.json_attributo_value.JsonAttributoValue(
                                attributo_id = 56, 
    ...
    def testJsonReadRunsBulkOutput(self):
        """Test JsonReadRunsBulkOutput"""
