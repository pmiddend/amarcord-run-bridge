...
class TestJsonReadAttributi(unittest.TestCase):
    """JsonReadAttributi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonReadAttributi:
        """Test JsonReadAttributi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonReadAttributi`
        """
        model = JsonReadAttributi()
        if include_optional:
    ...
    def testJsonReadAttributi(self):
        """Test JsonReadAttributi"""
