...
class TestJsonReadExperimentTypes(unittest.TestCase):
    """JsonReadExperimentTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonReadExperimentTypes:
        """Test JsonReadExperimentTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonReadExperimentTypes`
        """
        model = JsonReadExperimentTypes()
        if include_optional:
            return JsonReadExperimentTypes(
                ...
                experiment_type_id_to_run = [
                    amarcord_open.models.json_experiment_type_and_runs.JsonExperimentTypeAndRuns(
                        id = 56, 
                        runs = [
                            ''
                            ], 
    ...
    def testJsonReadExperimentTypes(self):
        """Test JsonReadExperimentTypes"""
