...
class TestJsonMergeResult(unittest.TestCase):
    """JsonMergeResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonMergeResult:
        """Test JsonMergeResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonMergeResult`
        """
        model = JsonMergeResult()
        if include_optional:
