...
class TestJsonReadIndexingResultsOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonReadIndexingResultsOutput:
        """Test JsonReadIndexingResultsOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonReadIndexingResultsOutput`
        """
        model = JsonReadIndexingResultsOutput()
        if include_optional:
    ...
    def testJsonReadIndexingResultsOutput(self):
        """Test JsonReadIndexingResultsOutput"""
