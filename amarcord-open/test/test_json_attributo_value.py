...
class TestJsonAttributoValue(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonAttributoValue:
        """Test JsonAttributoValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonAttributoValue`
        """
        model = JsonAttributoValue()
        if include_optional:
    ...
    def testJsonAttributoValue(self):
        """Test JsonAttributoValue"""
