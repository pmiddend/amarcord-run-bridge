...
class TestJsonReadMergeResultsOutput(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonReadMergeResultsOutput:
        """Test JsonReadMergeResultsOutput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonReadMergeResultsOutput`
        """
        model = JsonReadMergeResultsOutput()
        if include_optional:
    ...
    def testJsonReadMergeResultsOutput(self):
        """Test JsonReadMergeResultsOutput"""
