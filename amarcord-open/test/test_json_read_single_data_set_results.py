...
class TestJsonReadSingleDataSetResults(unittest.TestCase):
    """JsonReadSingleDataSetResults unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonReadSingleDataSetResults:
        """Test JsonReadSingleDataSetResults
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonReadSingleDataSetResults`
        """
        model = JsonReadSingleDataSetResults()
        if include_optional:
            return JsonReadSingleDataSetResults(
                ...
                chemical_id_to_name = [
                    amarcord_open.models.json_chemical_id_and_name.JsonChemicalIdAndName(
                        chemical_id = 56, 
                        name = '', )
                    ],
                ...
                data_set = amarcord_open.models.json_data_set_with_indexing_results.JsonDataSetWithIndexingResults(
    ...
    def testJsonReadSingleDataSetResults(self):
        """Test JsonReadSingleDataSetResults"""
