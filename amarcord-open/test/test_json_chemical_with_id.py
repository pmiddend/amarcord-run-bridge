...
class TestJsonChemicalWithId(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonChemicalWithId:
        """Test JsonChemicalWithId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonChemicalWithId`
        """
        model = JsonChemicalWithId()
        if include_optional:
            return JsonChemicalWithId(
                id = 56,
                beamtime_id = 56,
                name = '',
                responsible_person = '',
    ...
    def testJsonChemicalWithId(self):
        """Test JsonChemicalWithId"""
