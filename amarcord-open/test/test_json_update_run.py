...
class TestJsonUpdateRun(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonUpdateRun:
        """Test JsonUpdateRun
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonUpdateRun`
        """
        model = JsonUpdateRun()
        if include_optional:
            return JsonUpdateRun(
                id = 56,
