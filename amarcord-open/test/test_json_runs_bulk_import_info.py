...
class TestJsonRunsBulkImportInfo(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> JsonRunsBulkImportInfo:
        """Test JsonRunsBulkImportInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonRunsBulkImportInfo`
        """
        model = JsonRunsBulkImportInfo()
        if include_optional:
    ...
    def testJsonRunsBulkImportInfo(self):
        """Test JsonRunsBulkImportInfo"""
